...
st.title("CredX : Credit Risk Modeling")
...
with row4[1]:
    loan_purpose = st.selectbox('Loan Purpose',['Education','Home','Automobile','Personal'])
with row4[2]:
    loan_type = st.selectbox('Loan Type',['Unsecure','Secured'])
